...
const MAX_ANISO = 16;
export function noiseCanvas(size, octaves, contrast) {
...
export function panelCanvas(size = 512, { cells = 6, grime = 0.4, bolts = true, seed = 5 } = {}) {
    const c = document.createElement('canvas');
    c.width = c.height = size;
    const ctx = c.getContext('2d');
...
export function toNormal(canvas, strength = 2.2, repeat = 1) {
 ...
 */
export function addMacroVariation(material, macro, { scale = 0.1, albedo = 0.26, roughness = 0.5 } = {}) {
    ...
    material.onBeforeCompile = (shader) => {
        ...
        shader.fragmentShader = shader.fragmentShader
            .replace('void main() {', `uniform sampler2D uMacroMap;
...
//# sourceMappingURL=texgen.js.map